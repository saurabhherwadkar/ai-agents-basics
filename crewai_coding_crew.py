...
# Import config to ensure .env is loaded before agents run
import config  # noqa: F401 — ensures .env is loaded

# Print a welcome banner for the game crew
...
# Assemble the crew with all three agents, running tasks sequentially
crew = Crew(
